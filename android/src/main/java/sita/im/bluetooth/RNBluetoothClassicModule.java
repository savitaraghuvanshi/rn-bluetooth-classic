...
import sita.im.android.BiConsumer;
import sita.im.bluetooth.conn.AcceptFailedException;
import sita.im.bluetooth.conn.ConnectionAcceptor;
import sita.im.bluetooth.conn.ConnectionAcceptorFactory;
import sita.im.bluetooth.conn.ConnectionConnector;
import sita.im.bluetooth.conn.ConnectionConnectorFactory;
import sita.im.bluetooth.conn.ConnectionFailedException;
import sita.im.bluetooth.conn.StandardOption;
import sita.im.bluetooth.event.BluetoothStateEvent;
import sita.im.bluetooth.event.EventType;
import sita.im.bluetooth.conn.DeviceConnection;
import sita.im.bluetooth.conn.DeviceConnectionFactory;
import sita.im.bluetooth.device.NativeDevice;
import sita.im.bluetooth.receiver.ActionACLReceiver;
import sita.im.bluetooth.receiver.DiscoveryReceiver;
import sita.im.bluetooth.receiver.PairingReceiver;
import sita.im.bluetooth.receiver.StateChangeReceiver;
