...
import sita.im.bluetooth.conn.DelimitedStringDeviceConnectionImpl;
import sita.im.bluetooth.conn.DeviceConnectionFactory;
import sita.im.bluetooth.conn.RfcommAcceptorThreadImpl;
import sita.im.bluetooth.conn.RfcommConnectorThreadImpl;
...
public class RNBluetoothClassicPackage implements ReactPackage {
    ...
    /**
     * {@link DeviceConnectionFactory} provide specific type of {@link sita.im.bluetooth.conn.DeviceConnection}
     * based on the type requested by the user.
     */
    private Map<String, DeviceConnectionFactory> mConnectionFactories;

    /**
     * {@link ConnectionAcceptorFactory} provide specific type of {@link sita.im.bluetooth.conn.ConnectionAcceptor}
     * based on the type requested by the user.
     */
    private Map<String, ConnectionAcceptorFactory> mAcceptorFactories;

    /**
     * {@link ConnectionConnectorFactory} provide specific type of {@link sita.im.bluetooth.conn.ConnectionConnector}
     * based on the type requested by the user.
     */
    private Map<String, ConnectionConnectorFactory> mConnectorFactories;

    /**
     * Creates a new package with the default {@link sita.im.bluetooth.conn.DeviceConnectionFactory}
